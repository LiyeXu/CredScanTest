...
namespace CredScanGitHubTestRepo
{
    ...
    class TestAzureSqlConnectionStringMonitoring
    {
           ...
           string connstr3 = "server=tcp:credscandev.database.windows.net,1433;database=credscandev;Integrated Security=False;user=credscansmoketestuser;pwd=credscansmoketestpwd;";
    }
}
